...
const BePart: React.FC<BePartProps> = ({ showSecondaryCTA }) => {
  return (
    <section className="flex flex-col justify-center items-center mx-4 md:mx-20 mt-18 rounded-[18px] border border-[#000000] p-8 mb-6">
      ...
      <div className={`flex ${!showSecondaryCTA ? 'flex-col-reverse' : 'flex-row'} flex-wrap justify-center items-center gap-4`}>
        <Link
          href={"/resources"}
