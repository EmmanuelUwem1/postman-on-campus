...
function ResourcesPage() {
  return (
    <motion.section
      ...
      className="flex flex-col md:flex-row justify-start gap-8 items-center mx-4 md:mx-24 my-12"
    >
      <div className="flex flex-col justify-start items-start w-full md:w-1/2">
        ...
        <p className="text-[#757575] text-lg md:text-2xl font-medium py-2">
          We’re currently curating a collection of free, high-quality resources
          to help you learn, build, and innovate with APIs. Whether you’re a
          student, educator, or campus leader, our resources will empower you to
          master API development and collaboration.
        </p>
